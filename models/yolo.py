...
from models.experimental import MixConv2d, CrossConv, C3, GhostBottleneck, GhostBottleneckEca
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [Conv, Bottleneck, SPP, DWConv, MixConv2d, Focus, CrossConv, BottleneckCSP, C3, GhostBottleneck, GhostBottleneckEca]:
            c1, c2 = ch[f], args[0]
